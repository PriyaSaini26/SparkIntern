        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item">
                <a class="nav-link active" style="font-size: 25px;margin-left: 50px;" aria-current="page" href="#">View Customers</a>
              </li>
              <li class="nav-item">
                <a class="nav-link active" style="font-size: 25px;margin-left: 50px;" aria-current="page" href="http://localhost/myCodes/Transfer.php">Transfer Money</a>
              </li>
              <li class="nav-item">
                <a class="nav-link active" style="font-size: 25px;margin-left: 50px;" aria-current="page" href="#">Transaction History</a>
              </li>
            </ul>
...
<h4 class="my-3">Transfer To</h4>
    <select name="to" class="form-select" id="validationCustom04" required>
      <option selected disabled value="">Choose...</option>
...
<div class="form-floating mb-3">
  <input type="" class="form-control" id="floatingInput" placeholder="Amount">
